...
class TestSimpleCoreHandler:
    ...
    def test_write_file(self):
        array = create_dummy_array(5, 5, dtype=int)
        self.generic_test(
            new_arr=array,
            option='write',
            expected_sizes={'index': 5, 'columns': 5},
    ...
    def test_append_data(self):
        ...
        new_arr = create_dummy_array(4, 7, {
            'index': np.sort(np.array(list(map(str, range(5, 9))), dtype=int)),
            'columns': np.sort(np.array(list(map(str, range(7))), dtype=int))
        })
        self.generic_test(
            new_arr=new_arr,
            option='append',
            expected_sizes={'index': 9, 'columns': 7},
            expected_free_sizes={'index': 0, 'columns': 0}
        )
    ...
    def test_append_with_rewrite(self):
        ...
        new_arr = create_dummy_array(4, 8, {
            'index': np.sort(np.array(list(map(str, range(5, 9))), dtype=int)),
            'columns': np.sort(np.array(list(map(str, range(8))), dtype=int))
        })
        self.generic_test(
            new_arr=new_arr,
            option='append',
            expected_sizes={'index': 9, 'columns': 8},
            expected_free_sizes={'index': 0, 'columns': 0}
        )
    ...
    def test_append_with_perfect_rewrite(self):
        ...
        new_arr = create_dummy_array(5, 8, {
            'index': np.sort(np.array(list(map(str, range(5, 10))), dtype=int)),
            'columns': np.sort(np.array(list(map(str, range(8))), dtype=int))
        })
        self.generic_test(
            new_arr=new_arr,
    ...
    def test_update_data(self):
        ...
        new_arr = create_dummy_array(5, 5, {
            'index': np.sort(np.array(list(map(str, range(5))), dtype=int)),
            'columns': np.sort(np.array(list(map(str, range(5))), dtype=int))
        })
